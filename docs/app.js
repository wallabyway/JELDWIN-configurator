...
window.app = new Vue({
  ...
  methods: {
    ...
    init: function() {
      ...
      setInterval(e=> {this.viewstate++; this.viewstate%=4; this.setView(this.viewstate);},6000 );
    },
    ...
    initializeViewer: function(self) {
      ...
      var options = {
          ...
          urn: "svf/cladAwningWindow/Design.svf"
      }
